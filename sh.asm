...
fork1(void)
{
  ...
  exit();
     ...
     10b:	68 75 12 00 00       	push   $0x1275
     110:	6a 02                	push   $0x2
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 98 11 00 00       	push   $0x1198
     143:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 69 12 00 00       	push   $0x1269
     17e:	6a 02                	push   $0x2
...
00000190 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    printf(2, "Pipe Not implemented\n");
     1b0:	52                   	push   %edx
     1b1:	52                   	push   %edx
     1b2:	68 e5 11 00 00       	push   $0x11e5
     1b7:	6a 02                	push   $0x2
    ...
    printf(2, "Backgrounding not implemented\n");
     1cd:	50                   	push   %eax
     1ce:	50                   	push   %eax
     1cf:	68 8c 12 00 00       	push   $0x128c
     1d4:	6a 02                	push   $0x2
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1f9:	68 a2 11 00 00       	push   $0x11a2
     1fe:	6a 02                	push   $0x2
    ...
    printf(2, "Redirection Not Implemented\n");
     20a:	53                   	push   %ebx
     20b:	53                   	push   %ebx
     20c:	68 b2 11 00 00       	push   $0x11b2
     211:	6a 02                	push   $0x2
    ...
    printf(2, "List Not Implemented\n");
     21d:	51                   	push   %ecx
     21e:	51                   	push   %ecx
     21f:	68 cf 11 00 00       	push   $0x11cf
     224:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     233:	68 9b 11 00 00       	push   $0x119b
...
00000240 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     255:	68 fb 11 00 00       	push   $0x11fb
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     267:	6a 54                	push   $0x54
     269:	e8 42 0e 00 00       	call   10b0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     297:	6a 18                	push   $0x18
     299:	e8 12 0e 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     2e7:	6a 0c                	push   $0xc
     2e9:	e8 c2 0d 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     327:	6a 0c                	push   $0xc
     329:	e8 82 0d 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     367:	6a 08                	push   $0x8
     369:	e8 42 0d 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     399:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3bd:	50                   	push   %eax
     3be:	68 04 19 00 00       	push   $0x1904
  ...
  switch(*s){
     ...
     3da:	0f 8f c8 00 00 00    	jg     4a8 <gettoken+0x118>
     3e0:	3c 3a                	cmp    $0x3a,%al
     3e2:	7f 5a                	jg     43e <gettoken+0xae>
     3e4:	84 c0                	test   %al,%al
     3e6:	75 48                	jne    430 <gettoken+0xa0>
  ...
  if(eq)
     3ea:	8b 4d 14             	mov    0x14(%ebp),%ecx
     3ed:	85 c9                	test   %ecx,%ecx
     3ef:	74 05                	je     3f6 <gettoken+0x66>
    *eq = s;
     3f1:	8b 45 14             	mov    0x14(%ebp),%eax
     3f4:	89 38                	mov    %edi,(%eax)

  while(s < es && strchr(whitespace, *s))
     3f6:	39 df                	cmp    %ebx,%edi
     3f8:	72 0d                	jb     407 <gettoken+0x77>
     3fa:	eb 23                	jmp    41f <gettoken+0x8f>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     40d:	50                   	push   %eax
     40e:	68 04 19 00 00       	push   $0x1904
  ...
  *ps = s;
  ...
  switch(*s){
     430:	78 22                	js     454 <gettoken+0xc4>
     432:	3c 26                	cmp    $0x26,%al
     434:	74 08                	je     43e <gettoken+0xae>
     436:	8d 48 d8             	lea    -0x28(%eax),%ecx
     439:	80 f9 01             	cmp    $0x1,%cl
     43c:	77 16                	ja     454 <gettoken+0xc4>
  ret = *s;
     43e:	0f be f0             	movsbl %al,%esi
    s++;
     441:	83 c7 01             	add    $0x1,%edi
    break;
     444:	eb a4                	jmp    3ea <gettoken+0x5a>
     446:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     44d:	00 
     44e:	66 90                	xchg   %ax,%ax
  switch(*s){
     450:	3c 7c                	cmp    $0x7c,%al
     452:	74 ea                	je     43e <gettoken+0xae>
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     454:	39 df                	cmp    %ebx,%edi
     456:	72 27                	jb     47f <gettoken+0xef>
     458:	e9 87 00 00 00       	jmp    4e4 <gettoken+0x154>
     45d:	8d 76 00             	lea    0x0(%esi),%esi
     460:	0f be 07             	movsbl (%edi),%eax
     463:	83 ec 08             	sub    $0x8,%esp
     466:	50                   	push   %eax
     467:	68 fc 18 00 00       	push   $0x18fc
     46c:	e8 5f 07 00 00       	call   bd0 <strchr>
     471:	83 c4 10             	add    $0x10,%esp
     474:	85 c0                	test   %eax,%eax
     476:	75 1f                	jne    497 <gettoken+0x107>
      s++;
     478:	83 c7 01             	add    $0x1,%edi
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     47b:	39 fb                	cmp    %edi,%ebx
     47d:	74 4d                	je     4cc <gettoken+0x13c>
     47f:	0f be 07             	movsbl (%edi),%eax
     482:	83 ec 08             	sub    $0x8,%esp
     485:	50                   	push   %eax
     486:	68 04 19 00 00       	push   $0x1904
     48b:	e8 40 07 00 00       	call   bd0 <strchr>
     490:	83 c4 10             	add    $0x10,%esp
     493:	85 c0                	test   %eax,%eax
     495:	74 c9                	je     460 <gettoken+0xd0>
    ret = 'a';
     497:	be 61 00 00 00       	mov    $0x61,%esi
     49c:	e9 49 ff ff ff       	jmp    3ea <gettoken+0x5a>
     4a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  switch(*s){
     4a8:	3c 3e                	cmp    $0x3e,%al
     4aa:	75 a4                	jne    450 <gettoken+0xc0>
    if(*s == '>'){
     4ac:	80 7f 01 3e          	cmpb   $0x3e,0x1(%edi)
     4b0:	74 0d                	je     4bf <gettoken+0x12f>
    s++;
     4b2:	83 c7 01             	add    $0x1,%edi
  ret = *s;
     4b5:	be 3e 00 00 00       	mov    $0x3e,%esi
     4ba:	e9 2b ff ff ff       	jmp    3ea <gettoken+0x5a>
      s++;
     4bf:	83 c7 02             	add    $0x2,%edi
      ret = '+';
     4c2:	be 2b 00 00 00       	mov    $0x2b,%esi
     4c7:	e9 1e ff ff ff       	jmp    3ea <gettoken+0x5a>
  if(eq)
     4cc:	8b 45 14             	mov    0x14(%ebp),%eax
     4cf:	85 c0                	test   %eax,%eax
     4d1:	74 05                	je     4d8 <gettoken+0x148>
    *eq = s;
     4d3:	8b 45 14             	mov    0x14(%ebp),%eax
     4d6:	89 18                	mov    %ebx,(%eax)
  while(s < es && strchr(whitespace, *s))
     4d8:	89 df                	mov    %ebx,%edi
    ret = 'a';
     4da:	be 61 00 00 00       	mov    $0x61,%esi
     4df:	e9 3b ff ff ff       	jmp    41f <gettoken+0x8f>
  if(eq)
     4e4:	8b 55 14             	mov    0x14(%ebp),%edx
     4e7:	85 d2                	test   %edx,%edx
     4e9:	74 ef                	je     4da <gettoken+0x14a>
    *eq = s;
     4eb:	8b 45 14             	mov    0x14(%ebp),%eax
     4ee:	89 38                	mov    %edi,(%eax)
  while(s < es && strchr(whitespace, *s))
     4f0:	eb e8                	jmp    4da <gettoken+0x14a>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52d:	50                   	push   %eax
     52e:	68 04 19 00 00       	push   $0x1904
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     593:	68 1d 12 00 00       	push   $0x121d
     598:	53                   	push   %ebx
     599:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     5f0:	6a 18                	push   $0x18
     5f2:	e8 b9 0a 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     64f:	6a 18                	push   $0x18
     651:	e8 5a 0a 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd->cmd = subcmd;
     677:	89 47 04             	mov    %eax,0x4(%edi)
  cmd->file = file;
     67a:	89 4f 08             	mov    %ecx,0x8(%edi)
  cmd->efile = efile;
     67d:	89 57 0c             	mov    %edx,0xc(%edi)
  cmd->mode = mode;
     680:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
  cmd->fd = fd;
     687:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
      cmd = redircmd(cmd, q, eq, O_RDONLY, 0);
     68e:	89 7d 08             	mov    %edi,0x8(%ebp)
      break;
  ...
  return cmd;
     ...
     6ae:	68 00 12 00 00       	push   $0x1200
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6cf:	68 20 12 00 00       	push   $0x1220
     6d4:	56                   	push   %esi
     6d5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     6eb:	6a 54                	push   $0x54
     6ed:	e8 be 09 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     736:	68 37 12 00 00       	push   $0x1237
     73b:	56                   	push   %esi
     73c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     780:	68 29 12 00 00       	push   $0x1229
  ...
  cmd->eargv[argc] = 0;
     ...
     7c9:	68 22 12 00 00       	push   $0x1222
     7ce:	e8 9d f9 ff ff       	call   170 <panic>
     7d3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     7da:	00 
...
000007e0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7f9:	68 3c 12 00 00       	push   $0x123c
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     83d:	e8 6e 08 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000870 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     8a2:	e8 09 08 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 3e 12 00 00       	push   $0x123e
     8d0:	57                   	push   %edi
     8d1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 3a 12 00 00       	push   $0x123a
     8e6:	57                   	push   %edi
     8e7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     91d:	e8 8e 07 00 00       	call   10b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000950 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     95f:	68 20 12 00 00       	push   $0x1220
     964:	56                   	push   %esi
     965:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     989:	68 5c 12 00 00       	push   $0x125c
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  if(cmd == 0)
     ...
     9ec:	74 29                	je     a17 <nulterminate+0x37>
    return 0;

  switch(cmd->type){
     9ee:	83 3b 05             	cmpl   $0x5,(%ebx)
     9f1:	77 24                	ja     a17 <nulterminate+0x37>
     9f3:	8b 03                	mov    (%ebx),%eax
     9f5:	ff 24 85 c4 12 00 00 	jmp    *0x12c4(,%eax,4)
  ...
  return cmd;
    ...
    for(i=0; ecmd->argv[i]; i++)
     ...
     a3d:	74 d8                	je     a17 <nulterminate+0x37>
     a3f:	8d 43 08             	lea    0x8(%ebx),%eax
    ...
    for(i=0; ecmd->argv[i]; i++)
     ...
     a56:	75 f0                	jne    a48 <nulterminate+0x68>
}
    ...
    nulterminate(rcmd->cmd);
     ...
     a66:	e8 75 ff ff ff       	call   9e0 <nulterminate>
    *rcmd->efile = 0;
     ...
     a85:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     aa3:	68 b1 11 00 00       	push   $0x11b1
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ace:	52                   	push   %edx
     acf:	50                   	push   %eax
     ad0:	68 5e 12 00 00       	push   $0x125e
     ad5:	6a 02                	push   $0x2
     ad7:	e8 b4 03 00 00       	call   e90 <printf>
    panic("syntax");
     adc:	c7 04 24 22 12 00 00 	movl   $0x1222,(%esp)
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
     ...
     b33:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  ...
  return (uchar)*p - (uchar)*q;
     ...
     b54:	c9                   	leave
     b55:	c3                   	ret
     b56:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     b5d:	00 
  ...
  return (uchar)*p - (uchar)*q;
     ...
     b74:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     b7b:	00 
...
strlen(char *s)
{
  ...
  for(n = 0; s[n]; n++)
     ...
     ba5:	c3                   	ret
     ba6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     bad:	00 
...
strchr(const char *s, char c)
{
  ...
  return 0;
     ...
     c02:	5d                   	pop    %ebp
     c03:	c3                   	ret
     c04:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     c0b:	00 
     ...
     c19:	31 db                	xor    %ebx,%ebx
{
  ...
  return buf;
     ...
     c60:	5d                   	pop    %ebp
     c61:	c3                   	ret
     c62:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     c69:	00 
...
stat(char *n, struct stat *st)
{
  ...
  return r;
    ...
    return -1;
     ...
     cb7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     cbe:	00 
     cbf:	90                   	nop
...
atoi(const char *s)
{
  ...
  while('0' <= *s && *s <= '9')
     ...
     cd7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     cde:	00 
     cdf:	90                   	nop
    n = n*10 + *s++ - '0';
...
memmove(void *vdst, void *vsrc, int n)
{
  ...
  dst = vdst;
     ...
     d16:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     d1d:	00 
     ...
     df8:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e2b:	0f b6 92 34 13 00 00 	movzbl 0x1334(%edx),%edx
     ...
     e99:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     eb3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ef6:	0f 84 04 01 00 00    	je     1000 <printf+0x170>
     efc:	83 e8 63             	sub    $0x63,%eax
     eff:	83 f8 15             	cmp    $0x15,%eax
     f02:	77 1c                	ja     f20 <printf+0x90>
     f04:	ff 24 85 dc 12 00 00 	jmp    *0x12dc(,%eax,4)
  ...
  write(fd, &c, 1);
     ...
     f71:	e9 67 ff ff ff       	jmp    edd <printf+0x4d>
        s = (char*)*ap;
     f76:	8b 45 d0             	mov    -0x30(%ebp),%eax
     f79:	8b 18                	mov    (%eax),%ebx
        ap++;
     f7b:	83 c0 04             	add    $0x4,%eax
     f7e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
     f81:	85 db                	test   %ebx,%ebx
     f83:	0f 84 87 00 00 00    	je     1010 <printf+0x180>
        while(*s != 0){
     f89:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
     f8c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
     f8e:	84 c0                	test   %al,%al
     f90:	0f 84 47 ff ff ff    	je     edd <printf+0x4d>
     f96:	8d 55 e7             	lea    -0x19(%ebp),%edx
     f99:	89 75 d4             	mov    %esi,-0x2c(%ebp)
     f9c:	89 de                	mov    %ebx,%esi
     f9e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
  ...
  write(fd, &c, 1);
     ...
     fba:	75 e4                	jne    fa0 <printf+0x110>
      state = 0;
     fbc:	8b 75 d4             	mov    -0x2c(%ebp),%esi
     fbf:	31 d2                	xor    %edx,%edx
     fc1:	e9 17 ff ff ff       	jmp    edd <printf+0x4d>
        printint(fd, *ap, 10, 1);
     fc6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
     fc9:	83 ec 0c             	sub    $0xc,%esp
     fcc:	b9 0a 00 00 00       	mov    $0xa,%ecx
     fd1:	8b 13                	mov    (%ebx),%edx
     fd3:	6a 01                	push   $0x1
     fd5:	eb 88                	jmp    f5f <printf+0xcf>
        putc(fd, *ap);
     fd7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
     fda:	83 ec 04             	sub    $0x4,%esp
     fdd:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
     fe0:	8b 03                	mov    (%ebx),%eax
        ap++;
     fe2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
     fe5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
     fe8:	6a 01                	push   $0x1
     fea:	52                   	push   %edx
     feb:	57                   	push   %edi
     fec:	e8 62 fd ff ff       	call   d53 <write>
        ap++;
     ff1:	89 5d d0             	mov    %ebx,-0x30(%ebp)
     ff4:	83 c4 10             	add    $0x10,%esp
      state = 0;
     ff7:	31 d2                	xor    %edx,%edx
     ff9:	e9 df fe ff ff       	jmp    edd <printf+0x4d>
     ffe:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    1000:	83 ec 04             	sub    $0x4,%esp
    1003:	88 5d e7             	mov    %bl,-0x19(%ebp)
    1006:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1009:	6a 01                	push   $0x1
    100b:	e9 31 ff ff ff       	jmp    f41 <printf+0xb1>
    1010:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1015:	bb 83 12 00 00       	mov    $0x1283,%ebx
    101a:	e9 77 ff ff ff       	jmp    f96 <printf+0x106>
    101f:	90                   	nop
    ...
    1021:	a1 84 19 00 00       	mov    0x1984,%eax
{
  ...
  freep = p;
    ...
    105f:	5b                   	pop    %ebx
  freep = p;
    1060:	a3 84 19 00 00       	mov    %eax,0x1984
}
    1065:	5e                   	pop    %esi
    1066:	5f                   	pop    %edi
    1067:	5d                   	pop    %ebp
    ...
    1076:	72 ce                	jb     1046 <free+0x26>
{
  ...
  freep = p;
    109a:	a3 84 19 00 00       	mov    %eax,0x1984
    p->s.size += bp->s.size;
    109f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    10a2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    10a5:	89 08                	mov    %ecx,(%eax)
}
    10a7:	5b                   	pop    %ebx
    10a8:	5e                   	pop    %esi
    10a9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    10cd:	0f 84 8d 00 00 00    	je     1160 <malloc+0xb0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10d8:	39 f9                	cmp    %edi,%ecx
    10da:	73 64                	jae    1140 <malloc+0x90>
  if(nu < 4096)
    10dc:	bb 00 10 00 00       	mov    $0x1000,%ebx
    10e1:	39 df                	cmp    %ebx,%edi
    10e3:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    10e6:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    10ed:	eb 0a                	jmp    10f9 <malloc+0x49>
    10ef:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    10f0:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    10f2:	8b 48 04             	mov    0x4(%eax),%ecx
    10f5:	39 f9                	cmp    %edi,%ecx
    10f7:	73 47                	jae    1140 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    10fb:	3b 05 84 19 00 00    	cmp    0x1984,%eax
    1101:	75 ed                	jne    10f0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1103:	83 ec 0c             	sub    $0xc,%esp
    1106:	56                   	push   %esi
    1107:	e8 af fc ff ff       	call   dbb <sbrk>
  if(p == (char*)-1)
    110c:	83 c4 10             	add    $0x10,%esp
    110f:	83 f8 ff             	cmp    $0xffffffff,%eax
    1112:	74 1c                	je     1130 <malloc+0x80>
  hp->s.size = nu;
    1114:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1117:	83 ec 0c             	sub    $0xc,%esp
    111a:	83 c0 08             	add    $0x8,%eax
    111d:	50                   	push   %eax
    111e:	e8 fd fe ff ff       	call   1020 <free>
  return freep;
    1123:	8b 15 84 19 00 00    	mov    0x1984,%edx
      if((p = morecore(nunits)) == 0)
    1129:	83 c4 10             	add    $0x10,%esp
    112c:	85 d2                	test   %edx,%edx
    112e:	75 c0                	jne    10f0 <malloc+0x40>
        return 0;
  }
}
    ...
    1142:	74 4c                	je     1190 <malloc+0xe0>
        p->s.size -= nunits;
    ...
    1155:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    1158:	83 c0 08             	add    $0x8,%eax
}
    115b:	5b                   	pop    %ebx
    115c:	5e                   	pop    %esi
    115d:	5f                   	pop    %edi
    ...
    115f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1160:	c7 05 84 19 00 00 88 	movl   $0x1988,0x1984
    1167:	19 00 00 
    base.s.size = 0;
    116a:	b8 88 19 00 00       	mov    $0x1988,%eax
    base.s.ptr = freep = prevp = &base;
    116f:	c7 05 88 19 00 00 88 	movl   $0x1988,0x1988
    1176:	19 00 00 
    base.s.size = 0;
    1179:	c7 05 8c 19 00 00 00 	movl   $0x0,0x198c
    1180:	00 00 00 
    if(p->s.size >= nunits){
    1183:	e9 54 ff ff ff       	jmp    10dc <malloc+0x2c>
    1188:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    118f:	00 
        prevp->s.ptr = p->s.ptr;
    1190:	8b 08                	mov    (%eax),%ecx
    1192:	89 0a                	mov    %ecx,(%edx)
    1194:	eb b9                	jmp    114f <malloc+0x9f>
